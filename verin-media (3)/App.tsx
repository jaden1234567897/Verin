...
const App: React.FC = () => {
  ...
  return (
    <>
      ...
      {currentPage === 'individual-services' && <IndividualServices onNavigate={handleNavigate} />}
      ...
      <div className="fixed bottom-6 right-6 z-[9999] flex items-center justify-center pointer-events-none">
        ...
        <div className="absolute inset-0 bg-[#25D366] rounded-full animate-ripple opacity-40"></div>
        ...
        <a 
          ...
          className="pointer-events-auto relative bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:scale-110 hover:shadow-green-500/30 transition-all duration-300 flex items-center justify-center group"
